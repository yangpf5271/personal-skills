...
```bash
npx skills@latest add yangpf5271/personal-skills --skill architecture-designer --skill code-security --skill mcp-builder --skill planning-with-files --skill find-skills --skill skill-creator --skill agent-browser
```
