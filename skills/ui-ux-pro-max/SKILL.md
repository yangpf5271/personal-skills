---
name: ui-ux-pro-max
description: "UI/UX 设计智能系统：UI/UX design intelligence with 50 styles, 21 palettes, 50 font pairings, and 20 chart types across 9 stacks (React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui). Use when planning, building, designing, reviewing, or refining UI/UX code — covers 玻璃态、极简主义、暗色模式、调色板、可访问性、动画、排版, and integrates shadcn/ui MCP."
---
