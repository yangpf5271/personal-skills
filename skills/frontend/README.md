...
| [web-page-engineer](./web-page-engineer/) | 顶级 Web 页面工程师，产出 HTML/CSS/JS/React 视觉制品（页面/落地页/仪表板/原型/管理系统 UI） |
...
- **做完整 Web 项目**：`react-frontend-guide`（写代码）+ `web-page-engineer`（做视觉制品）+ `motion`（加动效）+ `web-quality`（测性能/a11y）
- **设计转代码**：已有设计稿时用 `ui-ux-pro-max`（按设计系统生成）→ `react-frontend-guide`（规范代码）
...
```bash
npx skills@latest add yangpf5271/personal-skills --skill react-frontend-guide --skill web-quality --skill ui-ux-pro-max --skill web-page-engineer --skill motion --skill canvas-design --skill mermaid-code-diagram
```
