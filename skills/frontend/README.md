...
```bash
npx skills@latest add yangpf5271/personal-skills --skill react-frontend-guide --skill web-quality --skill ui-ux-pro-max --skill web-design-engineer --skill motion --skill canvas-design --skill mermaid-code-diagram
```
