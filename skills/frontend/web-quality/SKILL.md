---
name: web-quality
description: Web 质量检测：Run an evidence-led web quality audit covering performance, accessibility, SEO, best practices, and agentic browsing. Use when asked to "audit my site", "review web quality", "run lighthouse audit", "check page quality", or "optimize my website".
license: MIT
metadata:
...
> 本目录内嵌 5 个专项参考技能（accessibility / best-practices / core-web-vitals / performance / seo），随本技能一起安装，不单独注册。
