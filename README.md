...
A curated set of 23 skills — browser automation, design, document creation (docx/pdf/pptx/xlsx), frontend guidelines, MCP building, research/writing, file-based planning, and more. Browse [`skills/`](./skills/) for the full list; each folder is one self-contained skill.
